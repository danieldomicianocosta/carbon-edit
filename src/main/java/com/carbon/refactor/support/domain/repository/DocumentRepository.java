...
/**
 * Repository interface for read-only operations on Document entities.
 */
public interface DocumentRepository extends ReadOnlyRepository<Document, Integer> {
     ...
     * @return A list of documents for the given user
     */
     ...
     * 
     * @param typeClaId The type classifier ID
     * @return A list of documents with the given type classifier
     */
    List<Document> findByTypeClaId(Integer typeClaId);
