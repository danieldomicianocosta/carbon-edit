...
/**
 * Repository interface for read-only operations on ProductModelBonus entities.
 */
public interface ProductModelBonusRepository extends ReadOnlyRepository<ProductModelBonus, Integer> {
