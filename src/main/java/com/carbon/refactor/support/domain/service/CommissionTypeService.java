...
/**
 * Service interface for read-only operations on CommissionType entities.
 */
public interface CommissionTypeService extends ReadOnlyService<CommissionType, Integer> {
