...
/**
 * Repository interface for read-only operations on PartnerBrand entities.
 */
public interface PartnerBrandRepository extends ReadOnlyRepository<PartnerBrand, Integer> {
