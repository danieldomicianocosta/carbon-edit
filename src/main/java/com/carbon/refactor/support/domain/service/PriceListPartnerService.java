...
/**
 * Service interface for read-only operations on PriceListPartner entities.
 */
public interface PriceListPartnerService extends ReadOnlyService<PriceListPartner, Integer> {
