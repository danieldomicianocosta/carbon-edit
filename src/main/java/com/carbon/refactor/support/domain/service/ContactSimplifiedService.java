...
/**
 * Service interface for read-only operations on ContactSimplified entities.
 */
public interface ContactSimplifiedService extends ReadOnlyService<ContactSimplified, Integer> {
