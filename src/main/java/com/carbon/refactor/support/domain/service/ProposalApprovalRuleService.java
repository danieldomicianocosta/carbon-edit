...
/**
 * Service interface for read-only operations on ProposalApprovalRule entities.
 */
public interface ProposalApprovalRuleService extends ReadOnlyService<ProposalApprovalRule, Integer> {
