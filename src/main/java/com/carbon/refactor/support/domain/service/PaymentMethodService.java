...
/**
 * Service interface for read-only operations on PaymentMethod entities.
 */
public interface PaymentMethodService extends ReadOnlyService<PaymentMethod, Integer> {
